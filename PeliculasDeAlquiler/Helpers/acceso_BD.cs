...
namespace PeliculasDeAlquiler.Helpers
{
    class acceso_BD
    {
        ...
        string cadena_conexion = "Provider=SQLNCLI11;workstation id=michael-pc.mssql.somee.com;packet size=4096;user id=michaeljsvs_SQLLogin_1;pwd=2nigamopz8;data source=michael-pc.mssql.somee.com;persist security info=False;initial catalog=michael-pc";
