...
namespace PeliculasDeAlquiler.Helpers
{
    class acceso_BD
    {
        ...
        string cadena_conexion = "Provider=SQLNCLI11;workstation id=peliculas-de-alquiler-mb.mssql.somee.com;packet size=4096;user id=martinabarella_SQLLogin_1;pwd=tqpoiginvq;data source=peliculas-de-alquiler-mb.mssql.somee.com;persist security info=False;initial catalog=peliculas-de-alquiler-mb";
