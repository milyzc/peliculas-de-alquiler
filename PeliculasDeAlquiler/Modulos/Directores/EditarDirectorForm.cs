...
namespace PeliculasDeAlquiler.Modulos.Directores
{
    public partial class EditarDirectorForm : Form
    {
        ...
        private void EditarDirectorForm_Load(object sender, EventArgs e)
        {
            ...
            DtpFechaNacimiento.Value = director.FechaNacimiento != DateTime.MinValue ? director.FechaNacimiento : DateTime.Today;
            //Si tiene la fecha minima (Si no se parseo la fecha de la base de datos) setea la fecha actual.
        }
